...
class DapokOrtuController extends Controller
{
    ...
    public function save (Request $r){
        ...
        $data      = DB::connection('daycare')->transaction(function() use($r,$app){
            ...
            $tmp->ortu_ayah_tgl_lahir     = $r->ortu_ayah_tgl_lahir;
            ...
            $tmp->ortu_ibu_tgl_lahir     = $r->ortu_ibu_tgl_lahir;
        ...
        try{
            ...
            $data = DB::connection('daycare')
                            ...
                            ->select(
                                'aa.ortu_ayah',
                                'aa.ortu_ayah_hp',
                                'aa.ortu_ayah_tgl_lahir',
                                'aa.ortu_ayah_agama_id',
                                'aa.ortu_ayah_wa',
                                'aa.ortu_ayah_kerja',
                                'aa.ortu_ayah_peru_id',
                                'aa.ortu_ibu',
                                'aa.ortu_ibu_tgl_lahir',
                                'aa.ortu_ibu_hp',
                                'aa.ortu_ibu_wa',
                                'aa.ortu_ibu_agama_id',
                                'aa.ortu_ibu_kerja',
                                'aa.ortu_ibu_peru_id',
                                'aa.provinsi_id',
                                'aa.kota_id',
