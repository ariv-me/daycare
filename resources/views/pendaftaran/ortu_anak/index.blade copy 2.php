            ...
            success: function(r) {
                ...
                if (data.length) {
                    for (i = 0; i < data.length; i++) {
                       ...
                       // tr.find('td:nth-child(7)').append('<div class="d-flex"><small><a href="javascript:;" class="btn btn-success btn-xs shadow  sharp mr-2 item_pilih2" data="'+data[i].anak_kode+'"><i class="fa fa-check"></i>  Pilih</a></small></div>'); 
