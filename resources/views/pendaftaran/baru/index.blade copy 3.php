            ...
            success: function(r) {
                ...
                if (data.length) {
                    for (i = 0; i < data.length; i++) {
                        ...
                        tr.find('td:nth-child(4)').append('<a href="javascript:;" class="btn btn-rounded btn-success btn-xs item_pilih"  data="'+data[i].anak_kode+'"><i class="fa fa-check"></i>  Pilih</a>'); 
