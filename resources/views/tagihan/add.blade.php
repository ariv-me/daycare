                ...
                <table class="table table-sm table-bordered mb-0 table-centered">
                    <thead>
                        <tr>
                            ...
                            <th width="10%" style="text-align: center; vertical-align: middle;">TARIF</th>
                            <th width="1%" style="text-align: center; vertical-align: middle;">AKSI</th>
                            <th width="10%" style="text-align: center; vertical-align: middle;">QTY</th>
                ...
                if (data.length) {
                    for (i = 0; i < data.length; i++) {
                        ...
                        tr.find('td:nth-child(4)').append($('<div>')
                            .html('<b class="text-dark">'+(data[i].detail_qty)+'</b>'));   
