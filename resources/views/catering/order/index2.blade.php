        ...
        <div class="card">
            ...
            <div class="card-footer">
                <div class="row">
                    ...
                    <div class="col-md-3" style="text-align: right">
                        <a href="{{ route('catering.order.index') }}" class="btn btn-danger btn-sm"><i class="fas fa-times"></i> BATAL</a>
...
<script type="text/javascript">
    ...
    $('#show_data').on('click','.item_edit',function(){
        ...
        $.ajax({
            type : "GET",
            url   : "{{ route('catering.order.detail_edit') }}",
            dataType : "JSON",
            data : {id:id},
            success: function(r){
    ...
    $('#show_data').on('click','.item_delete',function(){
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    type : "GET",
                    url   : "{{ route('catering.order.detail_void') }}",
                    dataType : "JSON",
                    data : {id,_token},
                    success: function(data){
